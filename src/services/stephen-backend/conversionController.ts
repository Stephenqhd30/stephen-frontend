...
export async function listConversionVoByPageUsingPost(
  ...
  return request<API.BaseResponsePageConversionVO_>('/api/conversion/list/page/vo', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function listMyConversionVoByPageUsingPost(
  ...
  return request<API.BaseResponsePageConversionVO_>('/api/conversion/my/list/page/vo', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
