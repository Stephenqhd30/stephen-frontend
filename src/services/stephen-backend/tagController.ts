...
export async function listTagByPage(body: API.TagQueryRequest, options?: { [key: string]: any }) {
...
export async function updateTag(body: API.TagUpdateRequest, options?: { [key: string]: any }) {
